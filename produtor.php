  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" action="/php/create(recebe).php">
        ...
        <label>Setor</label>
        <input name="setor" class="form-control" placeholder="">
        <label>Talhão</label>
        <input name="talhao" class="form-control" placeholder="">
        <label>Pluviosidade</label>
        <input name="pluviosidade" class="form-control" placeholder="">
        <label>NDVI</label>
        <input name="ndvi" class="form-control" placeholder="">
        <label>Mes</label>
        <input name="mes" type="month" class="form-control" placeholder="">
        <label>Produtividade</label>
        <input name="produtividade" class="form-control" placeholder="">
        <br>
